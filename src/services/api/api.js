...
export class Api {
  static async getSomeData (params) {
    // let endpoint = ApiConf.ENDPOINTS_MAP.get(ApiConf.EndpointNames.SOME)
    // return this.call('getSomeList', `${endpoint}`, Methods.GET, params)
  }
